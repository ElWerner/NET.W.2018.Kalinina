...
5. Разрабтать класс для имитации рулетки, реализующий возможность передавать сообщение и дополнительную инфрмацию (выигравшее число и цвет) игрокам, подписавшимся на событие. Продемонстрировать работу класса в консольном приложении.

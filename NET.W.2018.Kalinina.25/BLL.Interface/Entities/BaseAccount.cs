...
{
    /// <summary>
    /// A class that represents base bank account entity
    /// </summary>
    public class BaseAccount : BankAccount
    {
        ...
        /// </summary>
        private const double WITHDRAWCOEFFICIENT = 9;

        /// <summary>
        /// A filed to hold deposit coefficient to calculate bonus scores
        /// </summary>
        private const double DEPOSITCOEFFICIENT = 5;
        ...
        public BaseAccount(AccountOwner owner, string accountNumber, decimal invoiceAmount, double bonusScores,
